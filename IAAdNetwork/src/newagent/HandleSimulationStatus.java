	...
	public void run(SampleAdNetworkModified adNetwork, SimulationStatus simulationStatus) {
		...
		for (Iterator<CampaignLogReport> it = adNetwork.getLogReports().iterator(); it.hasNext();) {
			...
			if (n == 0) {
				...
				System.out.println("Campaign ID: " + campaignLogReport.getCampaignId() + " from day ["
						+ campaignLogReport.getDayStart() + " to " + campaignLogReport.getDayEnd() + "] "
						+ campaignLogReport.getTargetSegment() + " Reach Target: " + campaignLogReport.getReachImps()
						+ " First Price: " + campaignLogReport.getBudgetMilis() + " Second Price: "
						+ campaignLogReport.getSecondPrice() + " Service Level: " + campaignLogReport.getServiceLevel()
						+ " Bank Status: " + campaignLogReport.getBankStatus());
				System.out.println("-----------------------------------");
		...
		for (Iterator<CampaignLogReport> it = adNetwork.getLogReports().iterator(); it.hasNext();) {
			...
			if (n > 0) {
				if (campaignLogReport.getWinner() != null && campaignLogReport.getSecondPrice() == 0) {
					...
					// campaignLogReport.getCampaignId() + " from day [" +
					// campaignLogReport.getDayStart() + " to " +
					// campaignLogReport.getDayEnd() + "] " +
					// campaignLogReport.getTargetSegment() + " Reach Target: "
					// + campaignLogReport.getReachImps() + " First Price: " +
					// campaignLogReport.getBudgetMilis() + " Second Price: " +
					// campaignLogReport.getSecondPrice() + " Service Level: " +
					// campaignLogReport.getServiceLevel() + " Bank Status: " +
					// campaignLogReport.getBankStatus());
					// System.out.println("-----------------------------------");
				}
			}
			n++;
		...
		for (Iterator<CampaignLogReport> it = adNetwork.getWinCampaigns().iterator(); it.hasNext();) {
			...
			for (Iterator<CampaignLogReport> it1 = adNetwork.getLogReports().iterator(); it1.hasNext();) {
				...
				if (!found) {
					...
					for (Iterator<MarketSegment> it2 = campaignLogReport1.getTargetSegment().iterator(); it2
							.hasNext();) {
						MarketSegment marketSegment = it2.next();
						for (Iterator<MarketSegment> it3 = campaignLogReport.getTargetSegment().iterator(); it3
								.hasNext();) {
					...
					if (sameTarget) {
						...
						// System.out.println("Campaign ID: " +
						// campaignLogReport1.getCampaignId() + " from day [" +
						// campaignLogReport1.getDayStart() + " to " +
						// campaignLogReport1.getDayEnd() + "] " +
						// campaignLogReport1.getTargetSegment() + " Reach
						// Target: " + campaignLogReport1.getReachImps() + "
						// First Price: " + campaignLogReport1.getBudgetMilis()
						// + " Second Price: " +
						// campaignLogReport1.getSecondPrice() + " Service
						// Level: " + campaignLogReport1.getServiceLevel() + "
