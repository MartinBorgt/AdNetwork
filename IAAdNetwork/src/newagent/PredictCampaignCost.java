...
public class PredictCampaignCost {
	...
	public double predictMultidayPriceIndex(SampleAdNetworkModified adNetwork) {
		...
		// System.out.println("popularity bid divided by campaign length: " +
		// (storeValue / ((double)(campPeriod * usr.getProbability(segment)))));
		// popularity = ((double) storeValue) / ((double)(campPeriod *
		// usr.getProbability(segment)));
